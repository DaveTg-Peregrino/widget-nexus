/**
 * WestJet Vacation Excursions Widget
...
`;
    ...
    let deviceIdKey = 'westjet_device_id'; // To be made unique in initWidget
    let threadIdKey = 'westjet_thread_id'; // To be made unique in initWidget
    ...
    function initWidget(customerConfig) {
        ...
        deviceIdKey = `westjet_device_id_${config.channel}`;
        threadIdKey = `westjet_thread_id_${config.channel}`;
    ...
    async function initializeSessionAndThread(createIfNotFound = true) {
        ...
        initializationPromise = (async () => {
            ...
            try {
                ...
                console.error('💥 WestJet Widget Initialization Error:', error);
