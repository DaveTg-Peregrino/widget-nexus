...
:root {
  ...
  --nx-notification-dot-bg: #FAB100;
  --nx-header-bg: #009FE3;
  --nx-agent-bubble-bg: #FFFFFF;
  --nx-agent-bubble-border-color: #E0E0E0;
  --nx-user-bubble-bg: #D0E8F2;
  --nx-user-bubble-border-color: #A9CBDA;
  --nx-user-bubble-text-color: #009FE3;
  --nx-send-button-bg: #AEC1CA;
