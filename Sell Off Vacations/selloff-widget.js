...
:root {
  ...
  /* Themeable variables */
  --nx-button-bg: linear-gradient(270deg, #4FCFA1 0%, #00AFDD 100%);
  --nx-button-border-color: transparent;
  --nx-button-icon-color: #FFFFFF;
  --nx-notification-dot-bg: #E73A4E;
  --nx-header-bg: linear-gradient(270deg, #4FCFA1 0%, #00AFDD 100%);
  --nx-agent-bubble-bg: #FFFFFF;
  --nx-agent-bubble-border-color: #E0E0E0;
  --nx-user-bubble-bg: #FFE0D2;
  --nx-user-bubble-border-color: #FFD5C3;
  --nx-user-bubble-text-color: #00AFDD;
  --nx-send-button-bg: #FF621D;
...
`;
    ...
    const config = {
        ...
        primaryColor: '#4FCFA1',
        textColor: '#ffffff',
        companyName: 'Sell Off Vacations',
        welcomeMessage: 'Welcome to Sell Off Vacations! How can I assist you today?',
        apiUrl: 'https://nexus-staging-dupl.onrender.com',
        widgetId: null,
        pollingInterval: 5000,
        channel: 'selloff-web', // Predefined web channel identifier
        // Engagement settings
        enableGlow: true,
        enableSound: true,
        enablePulse: true,
