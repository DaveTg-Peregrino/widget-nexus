...
:root {
  ...
  /* Themeable variables */
  --nx-button-bg: #BED4DB;
  --nx-button-border-color: #004A63;
  --nx-button-icon-color: #004A63;
...
`;
    ...
    const config = {
        ...
        primaryColor: '#004A63',
        textColor: '#004A63',
        companyName: 'Royalton Groups',
        welcomeMessage: 'Welcome to Royalton Groups! How can I assist you today?',
        apiUrl: 'https://nexus-development-1.onrender.com',
        widgetId: null,
        pollingInterval: 5000,
        channel: 'royaltongroup-web', // Predefined web channel identifier
        // Engagement settings
        enableGlow: true,
        enableSound: true,
        enablePulse: true,
