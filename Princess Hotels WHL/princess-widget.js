...
:root {
  ...
  --nx-notification-dot-bg: #F8991C;
  --nx-header-bg: #06084D;
  --nx-agent-bubble-bg: #FFFFFF;
  --nx-agent-bubble-border-color: #E0E0E0;
  --nx-user-bubble-bg: #E6E6F8;
  --nx-user-bubble-border-color: #C2C2DB;
  --nx-user-bubble-text-color: #06084D;
  --nx-send-button-bg: #F8991C;
