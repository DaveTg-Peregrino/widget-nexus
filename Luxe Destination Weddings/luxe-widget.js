/**
 * Luxe Destination Weddings Widget
...
:root {
  ...
  --nx-notification-dot-bg: #F35609;
  --nx-header-bg: #2D60A4;
  --nx-agent-bubble-bg: #FFFFFF;
  --nx-agent-bubble-border-color: #E0E0E0;
  --nx-user-bubble-bg: #C6D7EE;
  --nx-user-bubble-border-color: #98B8BF;
  --nx-user-bubble-text-color: #2D60A4;
  --nx-send-button-bg: #BF885E;
...
`;
    ...
    const config = {
        ...
        primaryColor: '#BF885E',
        textColor: '#ffffff',
        companyName: 'Luxe Destination Weddings',
        welcomeMessage: 'Welcome to Luxe Destination Weddings! How can I assist you today?',
        apiUrl: 'https://nexus.peregrino.co',
        widgetId: null,
        pollingInterval: 5000,
        channel: 'luxe-web', // Predefined web channel identifier
        // Engagement settings
        enableGlow: true,
        enableSound: true,
        enablePulse: true,
