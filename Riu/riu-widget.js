...
:root {
  ...
  --nx-button-icon-color: #E4022B;
  --nx-notification-dot-bg: #E4022B;
  --nx-header-bg: #31363C;
  --nx-agent-bubble-bg: #E7F6FD;
  --nx-agent-bubble-border-color: #333333;
  --nx-user-bubble-bg: #F4F4F5;
  --nx-user-bubble-border-color: #333333;
  --nx-user-bubble-text-color: #31363C;
  --nx-send-button-bg: #FFFFFF;
  --nx-send-button-border-color: #E4022B;
  --nx-send-button-icon-color: #E4022B;
