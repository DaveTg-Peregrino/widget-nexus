...
:root {
  ...
  /* Themeable variables */
  --nx-button-bg: #C9F0F3;
  --nx-button-border-color: #00A1AD;
  --nx-button-icon-color: #02828B;
  --nx-notification-dot-bg: #FBCA12;
  --nx-header-bg: #00A1AD;
  --nx-agent-bubble-bg: #FFFFFF;
  --nx-agent-bubble-border-color: #E0E0E0;
  --nx-user-bubble-bg: #C9F0F3;
  --nx-user-bubble-border-color: #00A1AD;
  --nx-user-bubble-text-color: #00A1AD;
