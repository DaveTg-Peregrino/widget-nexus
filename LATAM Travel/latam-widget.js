...
:root {
  ...
  /* Themeable variables */
  --nx-button-bg: linear-gradient(90deg, #272160 0%, #D72253 150.83%);
  ...
  --nx-user-bubble-bg: #DFDDEA;
  --nx-user-bubble-border-color: #CCC6E8;
  --nx-user-bubble-text-color: #0F0050;
  --nx-send-button-bg: #BDBDBD;
  --nx-send-button-border-color: transparent;
  --nx-send-button-icon-color: #444444;
...
`;
    ...
    const config = {
        ...
        primaryColor: '#272160',
        textColor: '#ffffff',
        companyName: 'LATAM Travel',
        welcomeMessage: 'Welcome to LATAM Travel! How can I assist you today?',
        apiUrl: 'https://nexus-staging-dupl.onrender.com',
        widgetId: null,
        pollingInterval: 5000,
        channel: 'latam-web', // Predefined web channel identifier
        // Engagement settings
        enableGlow: true,
        enableSound: true,
        enablePulse: true,
