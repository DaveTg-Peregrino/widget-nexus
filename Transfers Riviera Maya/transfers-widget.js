...
:root {
  ...
  --nx-user-bubble-bg: #E4C7DD;
  --nx-user-bubble-border-color: #BB6AA7;
  --nx-user-bubble-text-color: #BB6AA7;
  --nx-send-button-bg: #687ADA;
  --nx-send-button-border-color: #687ADA;
