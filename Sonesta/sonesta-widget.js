...
:root {
  ...
  --nx-notification-dot-bg: #E4022B;
  --nx-header-bg: #000000;
  --nx-agent-bubble-bg: #E7F6FD;
  --nx-agent-bubble-border-color: transparent;
  --nx-user-bubble-bg: #F4F4F5;
  --nx-user-bubble-border-color: transparent;
  --nx-user-bubble-text-color: #000000;
  --nx-send-button-bg: #FFFFFF;
  --nx-send-button-border-color: #394954;
  --nx-send-button-icon-color: #394954;
...
`;
    ...
    const config = {
        ...
        textColor: '#ffffff',
        companyName: 'Sonesta',
        welcomeMessage: 'Welcome to Sonesta! How can I assist you today?',
        apiUrl: 'https://nexus.peregrino.co',
        widgetId: null,
        pollingInterval: 5000,
        channel: 'sonesta-web', // Predefined web channel identifier
        // Engagement settings
        enableGlow: true,
        enableSound: true,
        enablePulse: true,
